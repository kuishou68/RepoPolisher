...
var _a2, _b, _c, _d, _e, _f, _g, _h, _i, _j, _k, _l, _m, _n, _o, _p, _q, _r, _s, _t, _u, _v, _w, _x, _y, _z, _A, _B, _C, _D, _E, _F, _G, _H, _I, _J, _K, _L, _M, _N, _O, _P, _Q, _R, _S, _T, _U, _V, _W, _X, _Y, _Z, __, _$, _aa, _ba, _ca, _da, _ea, _fa, _ga, _ha, _ia, _ja, _ka, _la, _ma, _na, _oa, _pa, _qa, _ra, _sa, _ta, _ua, _va, _wa, _xa, _ya, _za, _Aa, _Ba, _Ca, _Da, _Ea, _Fa, _Ga, _Ha, _Ia, _Ja, _Ka, _La, _Ma, _Na, _Oa, _Pa, _Qa, _Ra, _Sa, _Ta, _Ua, _Va, _Wa, _Xa, _Ya, _Za, __a, _$a, _ab, _bb, _cb, _db, _eb, _fb, _gb, _hb, _ib, _jb, _kb, _lb, _mb, _nb, _ob, _pb, _qb, _rb, _sb, _tb, _ub, _vb, _wb, _xb, _yb, _zb, _Ab, _Bb, _Cb, _Db, _Eb, _Fb, _Gb, _Hb, _Ib, _Jb, _Kb, _Lb, _Mb, _Nb, _Ob, _Pb, _Qb, _Rb, _Sb, _Tb, _Ub, _Vb, _Wb, _Xb, _Yb;
  ...
  buildQueryFromSourceParams(chunks, _config) {
    ...
    return mergeQueries(chunks.map((chunk) => {
      ...
      if (isSQLWrapper(chunk)) {
        if ((_a3 = chunk.shouldOmitSQLParens) == null ? void 0 : _a3.call(chunk)) {
...
_v = entityKind, _u = ViewBaseConfig;
class View {
...
__publicField(ColumnAliasProxyHandler, _w, "ColumnAliasProxyHandler");
_x = entityKind;
...
__publicField(TableAliasProxyHandler, _x, "TableAliasProxyHandler");
...
__publicField(ForeignKeyBuilder, _y, "SQLiteForeignKeyBuilder");
_z = entityKind;
class ForeignKey {
...
__publicField(ForeignKey, _z, "SQLiteForeignKey");
function uniqueKeyName(table, columns) {
  return `${table[TableName]}_${columns.join("_")}_unique`;
}
class SQLiteColumnBuilder extends (_B = ColumnBuilder, _A = entityKind, _B) {
  constructor() {
    super(...arguments);
...
__publicField(SQLiteColumnBuilder, _A, "SQLiteColumnBuilder");
class SQLiteColumn extends (_D = Column, _C = entityKind, _D) {
  constructor(table, config) {
...
__publicField(SQLiteColumn, _C, "SQLiteColumn");
class SQLiteBigIntBuilder extends (_F = SQLiteColumnBuilder, _E = entityKind, _F) {
  constructor(name) {
...
__publicField(SQLiteBigIntBuilder, _E, "SQLiteBigIntBuilder");
class SQLiteBigInt extends (_H = SQLiteColumn, _G = entityKind, _H) {
  getSQLType() {
    return "blob";
  }
  mapFromDriverValue(value) {
...
__publicField(SQLiteBigInt, _G, "SQLiteBigInt");
class SQLiteBlobJsonBuilder extends (_J = SQLiteColumnBuilder, _I = entityKind, _J) {
  constructor(name) {
...
__publicField(SQLiteBlobJsonBuilder, _I, "SQLiteBlobJsonBuilder");
class SQLiteBlobJson extends (_L = SQLiteColumn, _K = entityKind, _L) {
  getSQLType() {
    return "blob";
  }
  mapFromDriverValue(value) {
...
__publicField(SQLiteBlobJson, _K, "SQLiteBlobJson");
class SQLiteBlobBufferBuilder extends (_N = SQLiteColumnBuilder, _M = entityKind, _N) {
  constructor(name) {
...
__publicField(SQLiteBlobBufferBuilder, _M, "SQLiteBlobBufferBuilder");
class SQLiteBlobBuffer extends (_P = SQLiteColumn, _O = entityKind, _P) {
  getSQLType() {
    return "blob";
  }
}
__publicField(SQLiteBlobBuffer, _O, "SQLiteBlobBuffer");
function blob(a, b) {
...
class SQLiteCustomColumnBuilder extends (_R = SQLiteColumnBuilder, _Q = entityKind, _R) {
...
__publicField(SQLiteCustomColumnBuilder, _Q, "SQLiteCustomColumnBuilder");
class SQLiteCustomColumn extends (_T = SQLiteColumn, _S = entityKind, _T) {
  constructor(table, config) {
    super(table, config);
...
__publicField(SQLiteCustomColumn, _S, "SQLiteCustomColumn");
...
class SQLiteBaseIntegerBuilder extends (_V = SQLiteColumnBuilder, _U = entityKind, _V) {
  constructor(name, dataType, columnType) {
...
__publicField(SQLiteBaseIntegerBuilder, _U, "SQLiteBaseIntegerBuilder");
class SQLiteBaseInteger extends (_X = SQLiteColumn, _W = entityKind, _X) {
  constructor() {
    super(...arguments);
...
__publicField(SQLiteBaseInteger, _W, "SQLiteBaseInteger");
class SQLiteIntegerBuilder extends (_Z = SQLiteBaseIntegerBuilder, _Y = entityKind, _Z) {
  constructor(name) {
...
__publicField(SQLiteIntegerBuilder, _Y, "SQLiteIntegerBuilder");
class SQLiteInteger extends (_$ = SQLiteBaseInteger, __ = entityKind, _$) {
}
__publicField(SQLiteInteger, __, "SQLiteInteger");
class SQLiteTimestampBuilder extends (_ba = SQLiteBaseIntegerBuilder, _aa = entityKind, _ba) {
...
__publicField(SQLiteTimestampBuilder, _aa, "SQLiteTimestampBuilder");
class SQLiteTimestamp extends (_da = SQLiteBaseInteger, _ca = entityKind, _da) {
  constructor() {
    super(...arguments);
...
__publicField(SQLiteTimestamp, _ca, "SQLiteTimestamp");
class SQLiteBooleanBuilder extends (_fa = SQLiteBaseIntegerBuilder, _ea = entityKind, _fa) {
  constructor(name, mode) {
...
__publicField(SQLiteBooleanBuilder, _ea, "SQLiteBooleanBuilder");
class SQLiteBoolean extends (_ha = SQLiteBaseInteger, _ga = entityKind, _ha) {
  constructor() {
    super(...arguments);
    __publicField(this, "mode", this.config.mode);
  }
...
__publicField(SQLiteBoolean, _ga, "SQLiteBoolean");
...
class SQLiteNumericBuilder extends (_ja = SQLiteColumnBuilder, _ia = entityKind, _ja) {
  constructor(name) {
...
__publicField(SQLiteNumericBuilder, _ia, "SQLiteNumericBuilder");
class SQLiteNumeric extends (_la = SQLiteColumn, _ka = entityKind, _la) {
  getSQLType() {
    return "numeric";
  }
}
__publicField(SQLiteNumeric, _ka, "SQLiteNumeric");
function numeric(name) {
  return new SQLiteNumericBuilder(name ?? "");
}
class SQLiteRealBuilder extends (_na = SQLiteColumnBuilder, _ma = entityKind, _na) {
  constructor(name) {
...
__publicField(SQLiteRealBuilder, _ma, "SQLiteRealBuilder");
class SQLiteReal extends (_pa = SQLiteColumn, _oa = entityKind, _pa) {
  getSQLType() {
    return "real";
  }
}
__publicField(SQLiteReal, _oa, "SQLiteReal");
function real(name) {
  return new SQLiteRealBuilder(name ?? "");
}
class SQLiteTextBuilder extends (_ra = SQLiteColumnBuilder, _qa = entityKind, _ra) {
...
__publicField(SQLiteTextBuilder, _qa, "SQLiteTextBuilder");
class SQLiteText extends (_ta = SQLiteColumn, _sa = entityKind, _ta) {
  constructor(table, config) {
    super(table, config);
...
__publicField(SQLiteText, _sa, "SQLiteText");
class SQLiteTextJsonBuilder extends (_va = SQLiteColumnBuilder, _ua = entityKind, _va) {
  constructor(name) {
...
__publicField(SQLiteTextJsonBuilder, _ua, "SQLiteTextJsonBuilder");
class SQLiteTextJson extends (_xa = SQLiteColumn, _wa = entityKind, _xa) {
  getSQLType() {
    return "text";
  }
  mapFromDriverValue(value) {
...
__publicField(SQLiteTextJson, _wa, "SQLiteTextJson");
function text(a, b = {}) {
  const { name, config } = getColumnNameAndConfig(a, b);
  if (config.mode === "json") {
...
__publicField(_SelectionProxyHandler, _ya, "SelectionProxyHandler");
let SelectionProxyHandler = _SelectionProxyHandler;
_Aa = entityKind, _za = Symbol.toStringTag;
class QueryPromise {
  constructor() {
    __publicField(this, _za, "QueryPromise");
  }
  catch(onRejected) {
...
__publicField(QueryPromise, _Aa, "QueryPromise");
...
class SQLiteTable extends (_Fa = Table, _Ea = entityKind, _Da = Table.Symbol.Columns, _Ca = InlineForeignKeys$1, _Ba = Table.Symbol.ExtraConfigBuilder, _Fa) {
  constructor() {
    super(...arguments);
    /** @internal */
...
__publicField(SQLiteTable, _Ea, "SQLiteTable");
/** @internal */
...
class SQLiteDeleteBase extends (_Ha = QueryPromise, _Ga = entityKind, _Ha) {
...
__publicField(SQLiteDeleteBase, _Ga, "SQLiteDelete");
...
__publicField(CasingCache, _Ia, "CasingCache");
class DrizzleError extends (_Ka = Error, _Ja = entityKind, _Ka) {
...
__publicField(DrizzleError, _Ja, "DrizzleError");
class TransactionRollbackError extends (_Ma = DrizzleError, _La = entityKind, _Ma) {
  constructor() {
    super({ message: "Rollback" });
  }
}
__publicField(TransactionRollbackError, _La, "TransactionRollbackError");
const InlineForeignKeys = Symbol.for("drizzle:PgInlineForeignKeys");
const EnableRLS = Symbol.for("drizzle:EnableRLS");
class PgTable extends (_Ra = Table, _Qa = entityKind, _Pa = InlineForeignKeys, _Oa = EnableRLS, _Na = Table.Symbol.ExtraConfigBuilder, _Ra) {
  constructor() {
    super(...arguments);
    /**@internal */
    __publicField(this, _Pa, []);
    /** @internal */
    __publicField(this, _Oa, false);
    /** @internal */
    __publicField(this, _Na);
  }
}
__publicField(PgTable, _Qa, "PgTable");
/** @internal */
...
__publicField(PrimaryKeyBuilder, _Sa, "PgPrimaryKeyBuilder");
_Ta = entityKind;
class PrimaryKey {
...
__publicField(PrimaryKey, _Ta, "PgPrimaryKey");
...
__publicField(Relation, _Ua, "Relation");
_Va = entityKind;
class Relations {
  constructor(table, config) {
    this.table = table;
...
__publicField(Relations, _Va, "Relations");
const _One = class _One extends (_Xa = Relation, _Wa = entityKind, _Xa) {
...
__publicField(_One, _Wa, "One");
let One = _One;
const _Many = class _Many extends (_Za = Relation, _Ya = entityKind, _Za) {
...
function extractTablesRelationalConfig(schema, configHelpers) {
  ...
  for (const [key, value] of Object.entries(schema)) {
    if (is(value, Table)) {
      ...
      const extraConfig = (_a3 = value[Table.Symbol.ExtraConfigBuilder]) == null ? void 0 : _a3.call(value, value[Table.Symbol.ExtraConfigColumns]);
      if (extraConfig) {
...
function createOne(sourceTable) {
  return function one(table, config) {
    return new One(
      ...
      table,
      config,
      (config == null ? void 0 : config.fields.reduce((res, f2) => res && f2.notNull, true)) ?? false
    );
  };
}
...
class SQLiteViewBase extends (_$a = View, __a = entityKind, _$a) {
}
__publicField(SQLiteViewBase, __a, "SQLiteViewBase");
_ab = entityKind;
class SQLiteDialect {
  constructor(config) {
    /** @internal */
      ...
      if (config.columns) {
        ...
        if (selectedColumns.length > 0) {
          selectedColumns = isIncludeMode ? selectedColumns.filter((c2) => {
            var _a3;
            return ((_a3 = config.columns) == null ? void 0 : _a3[c2]) === true;
...
__publicField(SQLiteDialect, _ab, "SQLiteDialect");
class SQLiteSyncDialect extends (_cb = SQLiteDialect, _bb = entityKind, _cb) {
...
__publicField(SQLiteSyncDialect, _bb, "SQLiteSyncDialect");
_db = entityKind;
...
__publicField(TypedQueryBuilder, _db, "TypedQueryBuilder");
_eb = entityKind;
...
__publicField(SQLiteSelectBuilder, _eb, "SQLiteSelectBuilder");
class SQLiteSelectQueryBuilderBase extends (_gb = TypedQueryBuilder, _fb = entityKind, _gb) {
  ...
  createJoin(joinType) {
    return (table, on) => {
      ...
      if (typeof tableName === "string" && ((_a3 = this.config.joins) == null ? void 0 : _a3.some((join) => join.alias === tableName))) {
...
__publicField(SQLiteSelectQueryBuilderBase, _fb, "SQLiteSelectQueryBuilder");
class SQLiteSelectBase extends (_ib = SQLiteSelectQueryBuilderBase, _hb = entityKind, _ib) {
  constructor() {
    super(...arguments);
    __publicField(this, "run", (placeholderValues) => {
      return this._prepare().run(placeholderValues);
...
__publicField(SQLiteSelectBase, _hb, "SQLiteSelect");
...
__publicField(QueryBuilder, _jb, "SQLiteQueryBuilder");
_kb = entityKind;
...
__publicField(SQLiteInsertBuilder, _kb, "SQLiteInsertBuilder");
class SQLiteInsertBase extends (_mb = QueryPromise, _lb = entityKind, _mb) {
...
__publicField(SQLiteInsertBase, _lb, "SQLiteInsert");
_nb = entityKind;
...
__publicField(SQLiteUpdateBuilder, _nb, "SQLiteUpdateBuilder");
class SQLiteUpdateBase extends (_pb = QueryPromise, _ob = entityKind, _pb) {
...
__publicField(SQLiteUpdateBase, _ob, "SQLiteUpdate");
const _SQLiteCountBuilder = class _SQLiteCountBuilder extends (_sb = SQL, _rb = entityKind, _qb = Symbol.toStringTag, _sb) {
  constructor(params) {
    super(_SQLiteCountBuilder.buildEmbeddedCount(params.source, params.filters).queryChunks);
    __publicField(this, "sql");
    __publicField(this, _qb, "SQLiteCountBuilderAsync");
    __publicField(this, "session");
    this.params = params;
...
__publicField(_SQLiteCountBuilder, _rb, "SQLiteCountBuilderAsync");
...
__publicField(RelationalQueryBuilder, _tb, "SQLiteAsyncRelationalQueryBuilder");
class SQLiteRelationalQuery extends (_vb = QueryPromise, _ub = entityKind, _vb) {
...
__publicField(SQLiteRelationalQuery, _ub, "SQLiteAsyncRelationalQuery");
class SQLiteSyncRelationalQuery extends (_xb = SQLiteRelationalQuery, _wb = entityKind, _xb) {
  sync() {
    return this.executeRaw();
  }
}
__publicField(SQLiteSyncRelationalQuery, _wb, "SQLiteSyncRelationalQuery");
class SQLiteRaw extends (_zb = QueryPromise, _yb = entityKind, _zb) {
...
__publicField(SQLiteRaw, _yb, "SQLiteRaw");
_Ab = entityKind;
...
__publicField(BaseSQLiteDatabase, _Ab, "BaseSQLiteDatabase");
class ExecuteResultSync extends (_Cb = QueryPromise, _Bb = entityKind, _Cb) {
...
__publicField(ExecuteResultSync, _Bb, "ExecuteResultSync");
_Db = entityKind;
...
__publicField(SQLitePreparedQuery, _Db, "PreparedQuery");
_Eb = entityKind;
class SQLiteSession {
  constructor(dialect) {
    this.dialect = dialect;
...
__publicField(SQLiteSession, _Eb, "SQLiteSession");
class SQLiteTransaction extends (_Gb = BaseSQLiteDatabase, _Fb = entityKind, _Gb) {
...
__publicField(SQLiteTransaction, _Fb, "SQLiteTransaction");
_Hb = entityKind;
...
__publicField(ConsoleLogWriter, _Hb, "ConsoleLogWriter");
_Ib = entityKind;
class DefaultLogger {
  constructor(config) {
...
__publicField(DefaultLogger, _Ib, "DefaultLogger");
_Jb = entityKind;
class NoopLogger {
  logQuery() {
  }
}
__publicField(NoopLogger, _Jb, "NoopLogger");
...
var projects = sqliteTable("projects", {
  ...
  githubTopics: text("github_topics", { mode: "json" }).$type(),
...
var analysisTasks = sqliteTable("analysis_tasks", {
  id: text("id").primaryKey(),
...
var prDrafts = sqliteTable("pr_drafts", {
  id: text("id").primaryKey(),
  projectId: text("project_id").notNull().references(() => projects.id, { onDelete: "cascade" }),
  ...
  issueIds: text("issue_ids", { mode: "json" }).$type(),
...
function getDbPath(userDataPath) {
  ...
  return path.join(dbDir, "repo-polisher.db");
}
...
}, y = (e, r, n, t2) => (N(e, r, "write to private field"), r.set(e, n), n);
...
class G {
  constructor({
    ...
    t2.forEach((s) => this.attachWindow(s)), electron.ipcMain.on(l, (s, a) => {
      Q({
        router: n,
        createContext: r,
        internalId: x(s, a),
...
function callProcedure(opts) {
  ...
  if (!(path2 in opts.procedures) || !((_a3 = opts.procedures[path2]) == null ? void 0 : _a3._def[type])) {
    throw new TRPCError({
      code: "NOT_FOUND",
...
const isServerDefault = typeof window === "undefined" || "Deno" in window || ((_Tb = (_Sb = globalThis.process) == null ? void 0 : _Sb.env) == null ? void 0 : _Tb.NODE_ENV) === "test" || !!((_Vb = (_Ub = globalThis.process) == null ? void 0 : _Ub.env) == null ? void 0 : _Vb.JEST_WORKER_ID) || !!((_Xb = (_Wb = globalThis.process) == null ? void 0 : _Wb.env) == null ? void 0 : _Xb.VITEST_WORKER_ID);
function getParseFn(procedureParser) {
  const parser4 = procedureParser;
  if (typeof parser4 === "function") {
    return parser4;
  }
  if (typeof parser4.parseAsync === "function") {
    return parser4.parseAsync.bind(parser4);
  }
  if (typeof parser4.parse === "function") {
    return parser4.parse.bind(parser4);
  }
  if (typeof parser4.validateSync === "function") {
    return parser4.validateSync.bind(parser4);
  }
  if (typeof parser4.create === "function") {
    return parser4.create.bind(parser4);
  }
  if (typeof parser4.assert === "function") {
    return (value) => {
      parser4.assert(value);
      return value;
    };
  }
...
function createInputMiddleware(parse2) {
  const inputMiddleware = async ({ next, rawInput, input }) => {
    ...
    const combinedInput = isPlainObject$2(input) && isPlainObject$2(parsedInput) ? {
      ...input,
      ...parsedInput
    } : parsedInput;
    return next({
...
function createBuilder(initDef = {}) {
  ...
  return {
    _def,
    input(input) {
      const parser4 = getParseFn(input);
      return createNewBuilder(_def, {
        inputs: [
          input
        ],
        middlewares: [
          createInputMiddleware(parser4)
        ]
      });
    },
    output(output) {
...
function createTRPCInner() {
  return function initTRPCInner(runtime) {
    ...
    const config = {
      transformer,
      isDev: (runtime == null ? void 0 : runtime.isDev) ?? ((_b2 = (_a3 = globalThis.process) == null ? void 0 : _a3.env) == null ? void 0 : _b2.NODE_ENV) !== "production",
...
async function fetchWrapper(requestOptions) {
  ...
  const log = ((_b2 = requestOptions.request) == null ? void 0 : _b2.log) || console;
  const parseSuccessResponseBody = ((_c2 = requestOptions.request) == null ? void 0 : _c2.parseSuccessResponseBody) !== false;
  ...
  try {
    fetchResponse = await fetch(requestOptions.url, {
      ...
      body,
      redirect: (_d2 = requestOptions.request) == null ? void 0 : _d2.redirect,
...
}, __publicField(_Yb, "VERSION", VERSION$5), __publicField(_Yb, "plugins", []), _Yb);
  ...
  (function(global2, factory) {
    ...
    Events = class Events {
      ...
      async trigger(name, ...args) {
        ...
        try {
          ...
          return (await Promise.all(promises2)).find(function(x2) {
            return x2 != null;
          });
        } catch (error) {
          e = error;
    ...
    Group = (function() {
      class Group2 {
        ...
        async clusterKeys() {
          var cursor, end, found, i2, k2, keys, len, next, start;
          if (this.connection == null) {
...
function routeMatcher(paths) {
  const regexes = paths.map(
    (path2) => path2.split("/").map((c2) => c2.startsWith("{") ? "(?:.+?)" : c2).join("/")
  );
...
var groups = {};
var createGroups = function(Bottleneck, common2) {
...
function throttling(octokit, octokitOptions) {
  ...
  const common2 = { timeout };
  if (typeof connection !== "undefined") {
    common2.connection = connection;
  }
...
(function(exports$1) {
  ...
  function exists2(path2, type = exports$1.READABLE) {
...
(function(exports$1) {
  function __export2(m2) {
    for (var p in m2) if (!exports$1.hasOwnProperty(p)) exports$1[p] = m2[p];
  }
  Object.defineProperty(exports$1, "__esModule", { value: true });
  __export2(src$1);
})(dist$1);
  ...
  "src/lib/tasks/grep.ts"() {
    ...
    GrepQuery = class {
      ...
      *[(_a = Query, Symbol.iterator)]() {
      ...
      and(...and2) {
        and2.length && this[Query].push("--and", "(", ...prefixedArray(and2, "-e"), ")");
        return this;
      }
      param(...param) {
...
var init_tasks_pending_queue = __esm({
  "src/lib/runners/tasks-pending-queue.ts"() {
    ...
    TasksPendingQueue = (_a3 = class {
      ...
      createProgress(task) {
        const name = _a3.getName(task.commands[0]);
...
function forEach(text2, handler2) {
  forEachLineWithContent(text2, (line) => handler2(line.split(/\s+/)));
}
...
function completionDetectionPlugin({
  ...
  return {
    ...
    async action(_data, { spawned, close }) {
      ...
      (_b2 = spawned.stderr) == null ? void 0 : _b2.on("data", quickClose);
...
function progressMonitorPlugin(progress) {
  ...
  const onProgress = {
    ...
    action(_data, context) {
      ...
      (_a3 = context.spawned.stderr) == null ? void 0 : _a3.on("data", (chunk) => {
  ...
  if (block > 0) {
    return {
      ...
      action(_data, context) {
        ...
        function stop() {
          var _a4, _b3;
          (_a4 = context.spawned.stdout) == null ? void 0 : _a4.off("data", wait);
          (_b3 = context.spawned.stderr) == null ? void 0 : _b3.off("data", wait);
        ...
        stdOut && ((_a3 = context.spawned.stdout) == null ? void 0 : _a3.on("data", wait));
        stdErr && ((_b2 = context.spawned.stderr) == null ? void 0 : _b2.on("data", wait));
...
function gitInstanceFactory(baseDir, options) {
  ...
  customBinaryPlugin(plugins, config.binary, (_a3 = config.unsafe) == null ? void 0 : _a3.allowUnsafeCustomBinary);
...
var GitHubAPI = class {
  ...
  async getTrendingAIProjects(options = {}) {
    const { limit = 30 } = options;
    const aiQuery = "ai OR machine-learning OR llm OR deep-learning";
    const projects2 = await this.searchRepositories(aiQuery, {
      minStars: 1e3,
      sort: "stars",
      order: "desc",
      perPage: limit
  ...
  async getRepoDetails(owner, repo) {
    try {
      ...
      if (project.github) {
        ...
        project.github.contributors = totalCount ? parseInt(String(totalCount), 10) : contributors.data.length;
      }
      return project;
    } catch {
      return null;
  ...
  repoToProject(repo) {
    ...
    const github = {
      owner: ((_a3 = repo.owner) == null ? void 0 : _a3.login) || "",
      repo: repo.name,
    ...
    return {
      id: nanoid(),
      source: "github",
      name: repo.full_name || `${(_b2 = repo.owner) == null ? void 0 : _b2.login}/${repo.name}`,
  ...
  classifyProject(repo) {
    const topics = (repo.topics || []).map((t2) => t2.toLowerCase());
    const description = (repo.description || "").toLowerCase();
    const name = (repo.name || "").toLowerCase();
    const hasAITopic = topics.some((t2) => AI_TOPICS.includes(t2));
    ...
    if (topics.some((t2) => webTopics.includes(t2))) {
      return "web";
    }
    const cliTopics = ["cli", "command-line", "terminal", "shell"];
    if (topics.some((t2) => cliTopics.includes(t2))) {
      return "cli";
    }
    const libTopics = ["library", "sdk", "framework", "package", "module"];
    if (topics.some((t2) => libTopics.includes(t2))) {
      return "library";
    }
    return "other";
  }
...
var LocalScanner = class {
  async scanDirectory(dirPath) {
    if (!require$$0.existsSync(dirPath)) {
      return null;
    }
  ...
  async getProjectInfo(dirPath) {
    ...
    if (require$$0.existsSync(pyprojectPath)) {
      try {
    ...
    if (require$$0.existsSync(gitDir)) {
      try {
  ...
  async scanLanguages(dirPath, depth = 0, maxDepth = 3) {
    const counts = {};
    if (depth > maxDepth) return counts;
    const entries = await promises.readdir(dirPath, { withFileTypes: true });
    for (const entry of entries) {
      if (entry.isDirectory() && ["node_modules", ".git", "dist", "build", "target", "__pycache__", ".next", "venv"].includes(
        entry.name
      )) {
        continue;
      }
  ...
  classifyProject(info) {
    const { description = "", keywords = [], languages } = info;
    const descLower = description.toLowerCase();
    const allKeywords = keywords.map((k2) => k2.toLowerCase());
    const hasAIKeyword = AI_KEYWORDS.some(
    ...
    if (cliIndicators.some((c2) => descLower.includes(c2) || allKeywords.includes(c2))) {
      return "cli";
    }
    const libIndicators = ["library", "sdk", "framework", "package"];
    if (libIndicators.some((l2) => descLower.includes(l2) || allKeywords.includes(l2))) {
      return "library";
    }
    return "other";
  }
};
var TypoChecker = class {
  constructor(options = {}) {
    __publicField(this, "binaryPath");
  ...
  async check(projectPath, taskId, projectId, onProgress) {
    return new Promise((resolve, reject) => {
      const args = ["--format", "json"];
      for (const pattern of this.exclude) {
        args.push("--exclude", pattern);
      }
      if (this.configPath && require$$0.existsSync(this.configPath)) {
      ...
      child.on("close", (code) => {
        ...
        try {
          const issues2 = this.parseOutput(stdout, taskId, projectId, projectPath);
          resolve(issues2);
        } catch (err) {
          reject(err);
        }
  ...
  parseOutput(output, taskId, projectId, basePath) {
    var _a3, _b2, _c2;
    const issues2 = [];
    if (!output.trim()) {
      return issues2;
    ...
    for (const line of lines) {
      ...
      try {
        ...
        if (typo.type === "typo") {
          const relativePath = typo.path.startsWith(basePath) ? typo.path.slice(basePath.length + 1) : typo.path;
          issues2.push({
            id: nanoid(),
            taskId,
            projectId,
            ...
            message: `"${typo.typo}" should be "${((_a3 = typo.corrections) == null ? void 0 : _a3[0]) || "unknown"}"`,
            severity: "warning",
            original: typo.typo,
            suggestion: (_b2 = typo.corrections) == null ? void 0 : _b2[0],
            context: ((_c2 = typo.context) == null ? void 0 : _c2.line) || "",
            confidence: 0.95,
            status: "open",
  ...
  async isAvailable() {
    return new Promise((resolve) => {
      const child = child_process.spawn(this.binaryPath, ["--version"]);
      child.on("close", (code) => {
        resolve(code === 0);
      });
      child.on("error", () => {
...
var DEFAULT_PATH_DIRS = ["/opt/homebrew/bin", "/usr/local/bin"];
function hasPathSeparator(candidate) {
  return candidate.includes("/") || candidate.includes("\\");
}
function collectExtraPaths() {
  const paths = new Set(DEFAULT_PATH_DIRS);
  const explicit = process.env.GH_CLI_PATH;
  if (explicit && hasPathSeparator(explicit)) {
    paths.add(path.dirname(explicit));
  }
  const shellResolved = resolveViaShell();
  if (shellResolved) {
    paths.add(path.dirname(shellResolved));
  }
  return Array.from(paths).filter(Boolean);
}
function resolveGhExecutable() {
  const explicit = process.env.GH_CLI_PATH;
  if (explicit && require$$0.existsSync(explicit)) {
    return explicit;
  }
  return "gh";
}
function resolveViaShell() {
  const shell = process.env.SHELL || "/bin/zsh";
  const resolved = child_process.spawnSync(shell, ["-lc", "command -v gh"], {
    encoding: "utf-8"
  });
  if (resolved.status === 0) {
    const path2 = resolved.stdout.trim();
    if (path2 && require$$0.existsSync(path2)) {
      return path2;
    }
  }
  return null;
}
function buildGhEnvironment() {
...
function getGhSpawnConfig() {
  const command = resolveGhExecutable();
  const env = buildGhEnvironment();
  const resolved = child_process.spawnSync(command, ["--version"], { env });
...
var AuthChecker = class {
  constructor() {
    __publicField(this, "ghCommand");
    __publicField(this, "ghEnv");
  ...
  runCommand(args) {
    return new Promise((resolve) => {
      ...
      const child = child_process.spawn(this.ghCommand, args, {
        env: this.ghEnv
      });
      let stdout = "";
      let stderr = "";
...
var GhCli = class {
  ...
  async createPR(draft) {
    try {
      ...
      const prUrl = urlMatch ? urlMatch[0] : void 0;
      const prNumber = prUrl ? parseInt(prUrl.split("/").pop() || "0", 10) : void 0;
      return {
        success: true,
        prUrl,
        prNumber
  ...
  async cloneRepo(owner, repo, targetDir) {
  ...
  async runGitOrThrow(args, errorMessage) {
  ...
  async ensureForkRemote(upstreamSlug) {
...
const t$4 = initTRPC.create({ isServer: true });
const projectRouter = t$4.router({
  // List all projects
  list: t$4.procedure.input(
    objectType({
      source: enumType(["github", "local"]).optional(),
      category: enumType(["ai", "web", "cli", "library", "other"]).optional(),
      search: stringType().optional(),
      sortBy: enumType(["stars", "name", "updatedAt", "issuesFound"]).default("updatedAt"),
  ...
  // Get single project
  get: t$4.procedure.input(objectType({ id: stringType() })).query(async ({ input }) => {
    const db2 = getDatabase();
    const result = await db2.select().from(projects).where(eq(projects.id, input.id));
    return result[0] || null;
  }),
  // Add local project
  addLocal: t$4.procedure.input(objectType({ path: stringType() })).mutation(async ({ input }) => {
    var _a3, _b2, _c2;
    ...
    await db2.insert(projects).values({
      ...
      localPath: (_a3 = project.local) == null ? void 0 : _a3.path,
      localGitRemote: (_b2 = project.local) == null ? void 0 : _b2.gitRemote,
      localLastModified: (_c2 = project.local) == null ? void 0 : _c2.lastModified,
      analysisCount: 0,
      issuesFound: 0,
      createdAt: now,
      updatedAt: now
  ...
  // Remove project
  remove: t$4.procedure.input(objectType({ id: stringType() })).mutation(async ({ input }) => {
    const db2 = getDatabase();
    await db2.delete(projects).where(eq(projects.id, input.id));
    return { success: true };
  }),
  // Fetch trending GitHub projects
  fetchTrending: t$4.procedure.input(
    objectType({
      category: enumType(["ai", "all"]).default("ai"),
    ...
    const fetchedProjects = opts.category === "ai" ? await api.getTrendingAIProjects({ limit: opts.limit }) : await api.searchRepositories("stars:>1000", {
      minStars: 1e3,
      perPage: opts.limit
    });
    const db2 = getDatabase();
    ...
    for (const project of fetchedProjects) {
      const existing = await db2.select().from(projects).where(eq(projects.name, project.name));
      if (existing.length === 0) {
        await db2.insert(projects).values({
          ...
          category: project.category,
          languages: project.languages,
          githubOwner: (_a3 = project.github) == null ? void 0 : _a3.owner,
          githubRepo: (_b2 = project.github) == null ? void 0 : _b2.repo,
          githubStars: (_c2 = project.github) == null ? void 0 : _c2.stars,
          githubForks: (_d2 = project.github) == null ? void 0 : _d2.forks,
          githubLastCommit: (_e2 = project.github) == null ? void 0 : _e2.lastCommit,
          githubContributors: (_f2 = project.github) == null ? void 0 : _f2.contributors,
          githubTopics: (_g2 = project.github) == null ? void 0 : _g2.topics,
          githubUrl: (_h2 = project.github) == null ? void 0 : _h2.url,
          analysisCount: 0,
          issuesFound: 0,
          createdAt: now,
          updatedAt: now
  ...
  // Get project stats
  stats: t$4.procedure.query(async () => {
    const db2 = getDatabase();
...
const t$3 = initTRPC.create({ isServer: true });
function getCacheDir() {
  const cacheDir = path.join(electron.app.getPath("userData"), "cache", "repos");
  if (!require$$0.existsSync(cacheDir)) {
    require$$0.mkdirSync(cacheDir, { recursive: true });
  }
  return cacheDir;
}
const analysisRouter = t$3.router({
  // Start analysis for a project
  start: t$3.procedure.input(
    objectType({
      projectId: stringType(),
      type: enumType(["typo"]).default("typo")
    })
  ).mutation(async ({ input }) => {
    const db2 = getDatabase();
    const [project] = await db2.select().from(projects).where(eq(projects.id, input.projectId));
    if (!project) {
      throw new Error("Project not found");
    }
    const taskId = nanoid();
    const now = /* @__PURE__ */ new Date();
    await db2.insert(analysisTasks).values({
      id: taskId,
    ...
    if (project.source === "local") {
      ...
      projectPath = path.join(cacheDir, project.githubOwner, project.githubRepo);
      if (!require$$0.existsSync(projectPath)) {
        require$$0.mkdirSync(path.join(cacheDir, project.githubOwner), { recursive: true });
    ...
    try {
      ...
      for (const issue of foundIssues) {
        await db2.insert(issues).values({
          id: issue.id,
          taskId: issue.taskId,
  ...
  // Get analysis task
  getTask: t$3.procedure.input(objectType({ taskId: stringType() })).query(async ({ input }) => {
    const db2 = getDatabase();
    const [task] = await db2.select().from(analysisTasks).where(eq(analysisTasks.id, input.taskId));
    return task || null;
  }),
  // Get issues for a project
  getIssues: t$3.procedure.input(
    objectType({
      projectId: stringType(),
      status: enumType(["open", "included", "ignored", "fixed"]).optional()
    })
  ).query(async ({ input }) => {
    const db2 = getDatabase();
    let query = db2.select().from(issues).where(eq(issues.projectId, input.projectId));
    if (input.status) {
      query = query.where(eq(issues.status, input.status));
    }
    return query.orderBy(desc(issues.createdAt));
  }),
  // Update issue status
  updateIssueStatus: t$3.procedure.input(
    objectType({
      issueId: stringType(),
      status: enumType(["open", "included", "ignored", "fixed"])
    })
  ).mutation(async ({ input }) => {
    const db2 = getDatabase();
    await db2.update(issues).set({ status: input.status }).where(eq(issues.id, input.issueId));
    return { success: true };
  }),
  // Batch update issue status
  updateBatchIssueStatus: t$3.procedure.input(
    objectType({
      issueIds: arrayType(stringType()),
      status: enumType(["open", "included", "ignored", "fixed"])
    })
  ).mutation(async ({ input }) => {
    const db2 = getDatabase();
    for (const issueId of input.issueIds) {
      await db2.update(issues).set({ status: input.status }).where(eq(issues.id, issueId));
    }
    return { success: true, count: input.issueIds.length };
  }),
  // Get analysis history for a project
  history: t$3.procedure.input(objectType({ projectId: stringType() })).query(async ({ input }) => {
    const db2 = getDatabase();
    return db2.select().from(analysisTasks).where(eq(analysisTasks.projectId, input.projectId)).orderBy(desc(analysisTasks.createdAt));
  }),
  // Check if typos-cli is available
  checkTypos: t$3.procedure.query(async () => {
    const checker = new TypoChecker();
  ...
  // Check auth status
  checkAuth: t$3.procedure.query(async () => {
    const authChecker = new AuthChecker();
    return authChecker.checkAll();
  }),
  // Get project path (local path or cached clone path)
  getProjectPath: t$3.procedure.input(objectType({ projectId: stringType() })).query(async ({ input }) => {
    const db2 = getDatabase();
    const [project] = await db2.select().from(projects).where(eq(projects.id, input.projectId));
    ...
    if (project.source === "local") {
      ...
      const cacheDir = getCacheDir();
      const projectPath = path.join(cacheDir, project.githubOwner, project.githubRepo);
      return require$$0.existsSync(projectPath) ? projectPath : null;
    }
  })
});
const t$2 = initTRPC.create({ isServer: true });
function ensureDirectory(path2) {
  if (require$$0.existsSync(path2)) {
    const stats = require$$0.statSync(path2);
    if (!stats.isDirectory()) {
      require$$0.rmSync(path2, { recursive: true, force: true });
      require$$0.mkdirSync(path2, { recursive: true });
    }
    return;
  }
  require$$0.mkdirSync(path2, { recursive: true });
...
async function ensureRepoCache(project) {
  ...
  const ownerDir = path.join(cacheDir, project.githubOwner);
  ensureDirectory(ownerDir);
  const repoPath = path.join(ownerDir, project.githubRepo);
  const git = esm_default();
  if (!require$$0.existsSync(repoPath)) {
    try {
  ...
  const stats = require$$0.statSync(repoPath);
  if (!stats.isDirectory()) {
    require$$0.rmSync(repoPath, { recursive: true, force: true });
    await git.clone(project.githubUrl, repoPath, ["--depth", "1"]);
  }
  return repoPath;
}
...
async function applyDraftIssueFixes(repoPath, draftIssues) {
  var _a3;
  ...
  const appliedIssueIds = /* @__PURE__ */ new Set();
  const warnings = [];
  for (const [relativePath, fileIssues] of issuesByFile.entries()) {
    const fullPath = path.join(repoPath, relativePath);
    if (!require$$0.existsSync(fullPath)) {
      warnings.push(`File not found: ${relativePath}`);
      continue;
    }
    const originalContent = require$$0.readFileSync(fullPath, "utf8");
    ...
    for (const issue of sortedIssues) {
      ...
      if (lineIndex < 0 || lineIndex >= lines.length) {
        const normalizedContext = (_a3 = issue.context) == null ? void 0 : _a3.trim();
      ...
      lines[lineIndex] = lineContent.slice(0, matchIndex) + replacement + lineContent.slice(matchIndex + target.length);
      modified = true;
      appliedIssueIds.add(issue.id);
    }
    if (modified) {
      require$$0.writeFileSync(fullPath, lines.join(newline), "utf8");
    }
  }
...
const prRouter = t$2.router({
  // Create PR draft from selected issues
  createDraft: t$2.procedure.input(
    objectType({
      projectId: stringType(),
      issueIds: arrayType(stringType()),
    ...
    const selectedIssues = await db2.select().from(issues).where(inArray(issues.id, input.issueIds));
    if (selectedIssues.length === 0) {
      throw new Error("No issues selected");
    }
    const title = input.title || `fix: correct ${selectedIssues.length} typo${selectedIssues.length > 1 ? "s" : ""} in codebase`;
    const issueList = selectedIssues.slice(0, 20).map((i2) => `- \`${i2.original}\` → \`${i2.suggestion}\` in \`${i2.filePath}:${i2.line}\``).join("\n");
    const body = input.body || `## Summary
...
Generated by [RepoPolisher](https://github.com/user/repo-polisher)`;
    ...
    const now = /* @__PURE__ */ new Date();
    await db2.insert(prDrafts).values({
      id: draftId,
      projectId: input.projectId,
      title,
      body,
    ...
    await db2.update(issues).set({ status: "included" }).where(inArray(issues.id, input.issueIds));
    return { draftId, title, body, branch };
  }),
  // Get PR draft
  getDraft: t$2.procedure.input(objectType({ draftId: stringType() })).query(async ({ input }) => {
    const db2 = getDatabase();
    const [draft] = await db2.select().from(prDrafts).where(eq(prDrafts.id, input.draftId));
    return draft || null;
  }),
  // List PR drafts for a project
  listDrafts: t$2.procedure.input(objectType({ projectId: stringType() })).query(async ({ input }) => {
    const db2 = getDatabase();
    return db2.select().from(prDrafts).where(eq(prDrafts.projectId, input.projectId)).orderBy(desc(prDrafts.createdAt));
  }),
  // Update PR draft
  updateDraft: t$2.procedure.input(
    objectType({
      draftId: stringType(),
      title: stringType().optional(),
      body: stringType().optional(),
      status: enumType(["draft", "ready"]).optional()
    })
  ).mutation(async ({ input }) => {
    const db2 = getDatabase();
    ...
    await db2.update(prDrafts).set(updates).where(eq(prDrafts.id, input.draftId));
    return { success: true };
  }),
  // Submit PR
  submit: t$2.procedure.input(
    objectType({
      draftId: stringType(),
      method: enumType(["gh-cli", "local"]).default("gh-cli")
    })
  ).mutation(async ({ input }) => {
    var _a3;
    try {
      ...
      const [project] = await db2.select().from(projects).where(eq(projects.id, draft.projectId));
      if (!project) {
        throw new Error("Project not found");
      }
      if (input.method === "local") {
        await db2.update(prDrafts).set({
          status: "submitted",
          submitMethod: "local",
      ...
      const draftIssues = ((_a3 = draft.issueIds) == null ? void 0 : _a3.length) ? await db2.select().from(issues).where(inArray(issues.id, draft.issueIds)) : [];
      ...
      if (result.success) {
        ...
        if (appliedIssueIds.length > 0) {
          await db2.update(issues).set({ status: "fixed" }).where(inArray(issues.id, appliedIssueIds));
        }
        if (draft.issueIds && draft.issueIds.length > 0) {
          ...
          if (skippedIssueIds.length > 0) {
            await db2.update(issues).set({ status: "open" }).where(inArray(issues.id, skippedIssueIds));
          }
        }
      }
  ...
  // Delete draft
  deleteDraft: t$2.procedure.input(objectType({ draftId: stringType() })).mutation(async ({ input }) => {
    const db2 = getDatabase();
    const [draft] = await db2.select().from(prDrafts).where(eq(prDrafts.id, input.draftId));
    if (draft == null ? void 0 : draft.issueIds) {
      await db2.update(issues).set({ status: "open" }).where(inArray(issues.id, draft.issueIds));
    }
    await db2.delete(prDrafts).where(eq(prDrafts.id, input.draftId));
    return { success: true };
  })
});
const t$1 = initTRPC.create({ isServer: true });
const settingsRouter = t$1.router({
  // Get a setting
  get: t$1.procedure.input(objectType({ key: stringType() })).query(async ({ input }) => {
    const db2 = getDatabase();
    const [setting] = await db2.select().from(settings).where(eq(settings.key, input.key));
    return (setting == null ? void 0 : setting.value) ?? null;
  }),
  // Set a setting
  set: t$1.procedure.input(
    objectType({
      key: stringType(),
      value: anyType()
    })
  ...
  // Get all settings
  getAll: t$1.procedure.query(async () => {
    const db2 = getDatabase();
    const allSettings = await db2.select().from(settings);
    return Object.fromEntries(allSettings.map((s) => [s.key, s.value]));
  }),
  // Delete a setting
  delete: t$1.procedure.input(objectType({ key: stringType() })).mutation(async ({ input }) => {
    const db2 = getDatabase();
    await db2.delete(settings).where(eq(settings.key, input.key));
    return { success: true };
  })
});
...
function createWindow() {
  ...
  X({ router: appRouter, windows: [mainWindow] });
  if (isDev) {
...
electron.ipcMain.handle("editor:openFile", async (_event, filePath, line) => {
  const args = line ? [`--goto`, `${filePath}:${line}`] : [filePath];
  const editors = process.platform === "darwin" ? ["code", "/Applications/Visual Studio Code.app/Contents/Resources/app/bin/code"] : process.platform === "win32" ? ["code.cmd", "code"] : ["code"];
  const tryOpenWithEditor = (editor) => {
    return new Promise((resolve) => {
      child_process.execFile(editor, args, { windowsHide: true }, (error) => {
        resolve(!error);
      });
    });
  };
